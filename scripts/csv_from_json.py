...
df_games.to_csv(CSV_DIR / "games.csv", index=False)
df_game_genres.to_csv(CSV_DIR / "game_genres.csv", index=False)
df_game_platforms.to_csv(CSV_DIR / "game_platforms.csv", index=False)
df_genres.to_csv(CSV_DIR / "genres.csv", index=False)
df_platforms.to_csv(CSV_DIR / "platforms.csv", index=False)

print("Saved CSV files to", CSV_DIR)
